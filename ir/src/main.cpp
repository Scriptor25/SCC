...
int main()
{
...

    {
            ...
            "fib");
        {
            ...
            auto ap = builder.CreateAlloc("ap", context.GetI32Type());
            auto bp = builder.CreateAlloc("bp", context.GetI32Type());
            auto ip = builder.CreateAlloc("ip", context.GetI32Type());
            ...
            "main");
        {
            ...
            auto np = builder.CreateOffset("np", argv, builder.CreateI64(1));
